// <copyright file="ActionBmpLoad.cs" company="BahaBulle">
// Copyright (c) BahaBulle. All rights reserved.
// </copyright>

namespace JHackson.Actions.Image.Actions
{
    using System;
    ...
    /// <summary>
    /// Provides a class that allows loading a file in bmp format.
    /// </summary>
    public class ActionBmpLoad : ActionBase
    {
